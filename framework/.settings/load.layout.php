...
<head>
  ...
  <link href='../wwwroot/css/animate.min.css' rel='stylesheet'/>

  <!--  Paper Dashboard core CSS    -->
  <link href='../wwwroot/css/paper-dashboard.css' rel='stylesheet'/>

  <!--  Fonts and icons     -->
  <link href='http://maxcdn.bootstrapcdn.com/font-awesome/latest/css/font-awesome.min.css' rel='stylesheet'>
  <link href='https://fonts.googleapis.com/css?family=Muli:400,300' rel='stylesheet' type='text/css'>
  <link href='../wwwroot/css/themify-icons.css' rel='stylesheet'>
</head>
<body>
<div class="wrapper">
        ...
        <div class="sidebar-wrapper">
            <div class="logo">
                <a href='index.php'><img src="wwwroot/img/logo.jpg" height="150" width="200"></a>
                <h4>Biblioteca</h4>
                <small></small>
    ...
    <!--   Core JS Files   -->
    <script src="wwwroot/js/jquery-1.10.2.js" type="text/javascript"></script>
	<script src="wwwroot/js/bootstrap.min.js" type="text/javascript"></script>

	<!--  Checkbox, Radio & Switch Plugins -->
	<script src="wwwroot/js/bootstrap-checkbox-radio.js"></script>
